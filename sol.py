...
# Constants
GRID_SIZE = 80
CELL_SIZE = 7.5  # Size of each cell in pixels
...
canvas = tk.Canvas(root, width=GRID_SIZE * CELL_SIZE+100, height=GRID_SIZE * CELL_SIZE+100)
canvas.pack()
...
def draw_zebra_head():
    ...
    head_x1 = (GRID_SIZE  - 5) * CELL_SIZE
    head_y1 = 0
    head_x2 = (GRID_SIZE + 5) * CELL_SIZE
    head_y2 = 10 * CELL_SIZE
...
def draw_zebra_legs():
    ...
    leg_height = 10 * CELL_SIZE
    leg_positions = [
        (GRID_SIZE // 4, GRID_SIZE - 10),
        (GRID_SIZE // 4 + 15, GRID_SIZE - 10),
        (3 * GRID_SIZE // 4 - 15, GRID_SIZE - 10),
        (3 * GRID_SIZE // 4, GRID_SIZE - 10)
    ]
