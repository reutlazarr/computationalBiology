...
weights = np.random.rand(num_neurons, num_neurons, input_len)
...
def train_som(data, weights, num_iterations, sigma, learning_rate):
    for t in range(num_iterations):
        ...
        sigma = decay_function(sigma, t, num_iterations)
        learning_rate = decay_function(learning_rate, t, num_iterations)

train_som(data, weights, num_iterations, sigma, learning_rate)
